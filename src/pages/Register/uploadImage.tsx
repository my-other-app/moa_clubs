  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="bg-white p-8 rounded-lg shadow-lg w-96 border-gray-700 border-2">
        ...
        {/* Form Submission */}
        <form onSubmit={handleSubmit} className='justify-center items-cente flex'>
        <button
            type="button"
            onClick={handleButtonClick}
            disabled={!clubLogoPreview}
            className={`w-64 r h-15 text-2xl bg-gray-700 text-white p-2 rounded-lg font-semibold hover:bg-gray-800 mt-4 ${
